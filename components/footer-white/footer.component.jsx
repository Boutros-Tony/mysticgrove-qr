...
<h3 className={`${styles[fontColor]}`}>Master distiller <img src={srcSign ? srcSign : "/assets/sign-black.svg"} alt="" />
</h3>
<h3 className={`${styles[fontColor]}`}>© 2023 MYSTIC GROVE <br className="br-phone"/> ALL RIGHTS RESERVED.</h3>
        ...
        <div className={styles.ageLinksHolder}>
                <Link href="/nutrition-information">Nutritional Information</Link>
